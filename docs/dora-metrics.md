...
Computed 2026-07-30T02:15:32Z for the trailing 90-day window (RFC #580).
...
| Metric | Value |
|---|---|
| Deployment frequency | 65.16 deployments/week (838 in 90d window) |
| Lead time for changes | insufficient data (gh CLI or jq not available) |
| Change failure rate | 6.8% (57/838 deployments) |
