...
**Envoy · k3s · ArgoCD · Harbor · Vault · GitLab · Terraform/Terragrunt · Mimir · Loki**
...
|---|---|---|
| Cluster | k3d (Terraform/Terragrunt), Traefik off | k3s v1.36.4+k3s1 (pinned, ADR-0030), 2 nodes |
