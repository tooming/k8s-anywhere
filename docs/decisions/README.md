...
- ADRs (one principle per file):
  ...
  - [ADR-0002](adr-0002-garage-not-minio.md) — Garage for S3-compatible storage (MinIO is out) — **Removed 2026-09-07, no replacement**
  ...
  - [ADR-0007](adr-0007-off-cluster-garage-tfstate-backend.md) — Off-cluster Garage as the Terraform-state backend — **Removed 2026-09-07, no replacement**
  ...
  - [ADR-0009](adr-0009-rabbitmq-message-broker.md) — RabbitMQ as the lab's message broker (plain manifests, always-on) — **Removed 2026-09-06, no replacement**
  ...
  - [ADR-0014](adr-0014-cilium-not-flannel-policy.md) — Cilium CNI, not k3s's bundled Flannel + NetworkPolicy controller — **Removed 2026-09-07, no replacement**
  ...
  - [ADR-0016](adr-0016-default-deny-networkpolicy.md) — Default-deny NetworkPolicy per namespace
  - [ADR-0017](adr-0017-pod-security-standards-restricted.md) — Pod Security Standards `restricted` profile across all namespaces
  - [ADR-0018](adr-0018-valkey-not-redis.md) — Valkey as the lab's cache / key-value store (supersedes ADR-0010) — **Removed 2026-09-06, no replacement**
  - [ADR-0019](adr-0019-kyverno-admission-engine.md) — Kyverno as the lab's admission policy engine (not OPA Gatekeeper) — **Removed 2026-09-07, no replacement**
  - [ADR-0020](adr-0020-argo-rollouts-progressive-delivery.md) — Argo Rollouts for progressive delivery (weight/pause canaries via Traefik's native traffic-routing, ADR-0040; SLO gate removed alongside Mimir, ADR-0041) — **Removed 2026-09-07, no replacement**
  - [ADR-0021](adr-0021-velero-backup-restore.md) — Velero for cluster + PVC backup/restore to Garage S3 — **Removed 2026-09-07, no replacement**
  - [ADR-0022](adr-0022-trivy-operator-supply-chain.md) — Trivy Operator for continuous vulnerability + SBOM scanning — **Removed 2026-09-07, no replacement**
  - [ADR-0023](adr-0023-kargo-promotion-pipeline.md) — Kargo for GitOps promotion pipelines (multi-stage, Warehouse-gated) — **Removed 2026-09-07, no replacement**
  - [ADR-0024](adr-0024-harbor-not-artifactory.md) — Harbor as the on-demand artifact registry (supersedes ADR-0011) — **Removed 2026-09-07, no replacement**
  ...
  - [ADR-0029](adr-0029-keda-event-driven-autoscaling.md) — KEDA for event-driven autoscaling (RabbitMQ/Prometheus-triggered scaling, augments the stock HPA) — **Removed 2026-09-06, no replacement**
  ...
  - [ADR-0039](adr-0039-s3manager-garage-browser-ui.md) — s3manager as the lab's Garage (S3) browser UI (retroactive governance record) — **Removed 2026-09-07, no replacement**
