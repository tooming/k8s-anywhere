...
- ADRs (one principle per file):
  ...
  - [ADR-0027](adr-0027-first-cloud-backend-oracle-always-free-k3s.md) — First cloud backend: Oracle Cloud Always Free (Ampere A1) + self-managed k3s — **Superseded by ADR-0028**
  - [ADR-0028](adr-0028-oracle-cloud-backend-rejected.md) — Oracle Cloud rejected as a cloud backend (supersedes ADR-0027); no replacement chosen yet
