...
| 4 | ack-resources, data-demo, capstone-networkpolicy, data-networkpolicy, observability-networkpolicy, vault-networkpolicy, storage-networkpolicy, argocd-networkpolicy, moto-networkpolicy, ack-networkpolicy, lab-gateway-networkpolicy | ACK `Bucket` CRs (need the controller); data-demo traffic generators (need rabbitmq + valkey); NetworkPolicy fan-out overlays (need namespaces created by waves 1–3) |
