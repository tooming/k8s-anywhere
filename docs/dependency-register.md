...
| Grafana | always-on-core (observability stack) | grafana.com, github.com/grafana/grafana | [ADR-0006](decisions/adr-0006-grafana-native-git-sync.md) | 2026-08-19 (GHSA sweep: checked `github.com/grafana/grafana/security/advisories` directly — all 10 published advisories date 2022-2023 (newest: Mar 2023), none apply to the current `13.0.6` image; image tag bumped `13.0.5`→`13.0.6` 2026-08-18, chart stays pinned at `12.10.4`, still current) |
