...
| **On-demand (heavy)** | TiDB Operator (`make tidb-operator-up` / `make tidb-operator-down`) · TiDB cluster (`make tidb-up` / `make tidb-down`) · Artifactory/Nexus · Istio ambient mesh + Kiali · Longhorn |
