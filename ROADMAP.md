...
- [ ] 🟢 **Traefik basicAuth Middleware for the Argo Rollouts dashboard**
  (RFC #1479 — architect decision 2026-09-07, closing audit #1478 — the
  architect's decision is binding, promoted straight to 🟢 by the planner per
  ROADMAP's own "architect-decided items are also 🟢" rule). Closes a Critical,
