...
- [x] 🟢 **Correct a fabricated GHSA ID in `docs/dependency-register.md`'s Harbor
  ...
  verification writeup:
  [docs/done/2026-09-07-harbor-ghsa-56j8-fabricated-id-correction.md](docs/done/2026-09-07-harbor-ghsa-56j8-fabricated-id-correction.md).
  (auto/harbor-ghsa-56j8-fabricated-id-correction)
...
- [x] 🟢 **Traefik basicAuth Middleware for the Argo Rollouts dashboard** —
  ...
  (auto/argo-rollouts-dashboard-basicauth)
...
- [x] 🟢 **JANITOR-fallback: post-2026-09-06-removal-wave Makefile help-text
  ...
  [docs/done/2026-09-07-adr-0041-makefile-help-drift-cleanup.md](docs/done/2026-09-07-adr-0041-makefile-help-drift-cleanup.md).
  (chore/adr-0041-makefile-help-drift-cleanup)
...
- [x] 🟢 **Fix stale "shared Gateway HTTPS listener" terminology in CHARTER.md,
  ...
  verification writeup:
  [docs/done/2026-09-07-traefik-gateway-doc-drift-fix.md](docs/done/2026-09-07-traefik-gateway-doc-drift-fix.md).
...
- [x] 🟢 **Dependency exit runbooks for the lab's top concentration risks — closes
  ...
  (PR #1242)
- [x] 🟢 **Rename `scripts/gitlab-*.sh` → `scripts/forgejo-*.sh` + matching
  `Makefile` targets** — closed as moot 2026-09-07 (GitLab and Forgejo were both
  removed entirely, no replacement, before any rename ever shipped) — full record
  (original description + investigation update history):
  [docs/done/2026-09-15-gitlab-forgejo-rename-item-trim.md](docs/done/2026-09-15-gitlab-forgejo-rename-item-trim.md).
  (chore/gitlab-forgejo-rename-item-trim)
...
- [x] 🟢 **KEDA admission webhook TLS — wire to cert-manager's `k8s-lab-ca`** — full
  verification writeup:
  [docs/done/2026-07-17-keda-webhook-cert-manager-tls.md](docs/done/2026-07-17-keda-webhook-cert-manager-tls.md).
  (auto/keda-webhook-cert-manager-tls; PR #458)
...
- [x] 🟢 **`argo-cd` Helm chart major bump — `9.7.1` → `10.2.1`** — full verification
  writeup:
  [docs/done/2026-07-28-argocd-chart-bump-9-7-1-to-10-2-1.md](docs/done/2026-07-28-argocd-chart-bump-9-7-1-to-10-2-1.md).
  (auto/argocd-chart-10x-bump; PR #788) Closes #785.
...
- [x] 🟢 **`docs/dependency-register.md` — add rows for ADR-0033 (GitLab) and ADR-0034
  (LGTMP observability internals)** — full verification writeup:
  [docs/done/2026-08-07-dependency-register-adr-0033-0034-rows.md](docs/done/2026-08-07-dependency-register-adr-0033-0034-rows.md).
  (auto/dependency-register-adr-0033-0034-rows; PR #1076)
